...
public class WeaponSocket : MonoBehaviour
{
    ...
    public Vector3 weaponHoldPosition = Vector3.zero;
    public Vector3 weaponHoldRotation = new Vector3(-90f, 0f, 0f);
    ...
    public void EquipWeapon(GameObject weapon)
    {
        ...
        {
            if (finishedObj != null)
                ownerData.equippedWeapon = new WeaponData(weapon.name, finishedObj.metalTier, finishedObj.bladeLength);
